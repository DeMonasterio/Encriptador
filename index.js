...
function desencriptar() {
    ...
    if (texto === '') {
      // Si no hay texto ingresado, un mensaje de advertencia
      const title = document.querySelector(".msg__title");
      const paragraph = document.querySelector('.msg__paragraph');
      ...
      // Si el texto contiene alguna de las palabras clave de encriptación, se desencripta
      ...
      // Si el texto no necesita desencriptación 
